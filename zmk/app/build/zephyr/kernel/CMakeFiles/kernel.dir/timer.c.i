# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/syscall_handler.h" 1
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 2
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 2
...
# 15 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 2

static struct k_spinlock lock;
# 27 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
void z_timer_expiration_handler(struct _timeout *t)
{
 struct k_timer *timer = ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(t)), __typeof__(((struct k_timer *)0)->timeout)) || __builtin_types_compatible_p(__typeof__(*(t)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct k_timer *)(((char *)(t)) - 
# 29 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                        __builtin_offsetof (
# 29 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                        struct k_timer
# 29 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                        , 
# 29 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
...
# 46 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
 ...
 if (!((timer->period).ticks == (((k_timeout_t) {0})).ticks) &&
     !((timer->period).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
  k_timeout_t next = timer->period;


  next.ticks = (((next.ticks - 1) > (0)) ? (next.ticks - 1) : (0));
# 74 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
  next = ((k_timeout_t) { .ticks = ((((k_ticks_t) -1) - 1 - ((k_ticks_t)(((k_uptime_ticks() + 1 + next.ticks) > (0)) ? (k_uptime_ticks() + 1 + next.ticks) : (0))))) });
 ...
 if (timer->expiry_fn != 
# 84 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                        ((void *)0)
# 84 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                            ) {
 ...
 if (thread == 
# 98 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
              ((void *)0)
# 98 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                  ) {
  k_spin_unlock(&lock, key);
  return;
 }
    ...
    k_timer_stop_t stop_fn)
{
 ...
 do { } while (
# 127 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
0
# 127 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
);

 timer->user_data = 
# 129 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                   ((void *)0)
# 129 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                       ;
...
{
 do { } while (
# 142 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
0
# 142 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
);

 if (((duration).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
  return;
 }
# 161 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
 if ((((k_ticks_t) -1) - 1 - (duration.ticks)) < 0) {
  duration.ticks = (((duration.ticks - 1) > (0)) ? (duration.ticks - 1) : (0));
 }
...
# 184 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
void z_impl_k_timer_stop(struct k_timer *timer)
{
 do { } while (
# 186 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
0
# 186 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
);

 
# 188 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
_Bool 
# 188 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
 ...
 if (timer->stop_fn != 
# 194 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                      ((void *)0)
# 194 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                          ) {
  timer->stop_fn(timer);
 }
 ...
 if (1) {
  ...
  if (pending_thread != 
# 201 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
                       ((void *)0)
# 201 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
                           ) {
...
# 217 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
...
# 237 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
uint32_t z_impl_k_timer_status_sync(struct k_timer *timer)
{
 { };
 do { } while (
# 240 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
0
# 240 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
);
...
# 260 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
          1
# 260 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
              );
 ...
 if (result == 0U) {
  if (!z_is_inactive_timeout(&timer->timeout)) {
   do { } while (
# 270 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
  0
# 270 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
  );


   (void)z_pend_curr(&lock, key, &timer->wait_q, ((k_timeout_t) { .ticks = (((k_ticks_t) -1)) }));
 ...
 do { } while (
# 291 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c" 3 4
0
# 291 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timer.c"
);
