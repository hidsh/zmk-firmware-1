# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 2

# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/syscall_handler.h" 1
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 2


static uint64_t curr_tick;

static sys_dlist_t timeout_list = { {(&timeout_list)}, {(&timeout_list)} };
...
# 39 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
static struct _timeout *first(void)
{
 sys_dnode_t *t = sys_dlist_peek_head(&timeout_list);

 return t == 
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
            ((void *)0) 
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                 ? 
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                   ((void *)0) 
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                        : ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(t)), __typeof__(((struct _timeout *)0)->node)) || __builtin_types_compatible_p(__typeof__(*(t)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct _timeout *)(((char *)(t)) - 
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                          __builtin_offsetof (
# 43 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                          struct _timeout
...
static struct _timeout *next(struct _timeout *t)
{
 ...
 return n == 
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
            ((void *)0) 
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                 ? 
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                   ((void *)0) 
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                        : ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(n)), __typeof__(((struct _timeout *)0)->node)) || __builtin_types_compatible_p(__typeof__(*(n)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct _timeout *)(((char *)(n)) - 
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                          __builtin_offsetof (
# 50 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                          struct _timeout
...
{
 if (next(t) != 
# 55 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
               ((void *)0)
# 55 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                   ) {
...
{
# 80 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
...
static int32_t next_timeout(void)
{
 ...
 if ((to == 
# 89 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
           ((void *)0)
# 89 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
               ) ||
     ((int64_t)(to->dticks - ticks_elapsed) > (int64_t)0x7fffffff)) {
  ret = (0 ? ((k_ticks_t) -1) : 0x7fffffff);
 } else {
  ret = (((0) > (to->dticks - ticks_elapsed)) ? (0) : (to->dticks - ticks_elapsed));
 }
     ...
     k_timeout_t timeout)
{
 ...
 for (k_spinlock_key_t __i = {}, __key = k_spin_lock(&timeout_lock); !__i.key; k_spin_unlock(&timeout_lock, __key), __i.key = 1) {
  struct _timeout *t;

  if (1 &&
      (((k_ticks_t) -1) - 1 - (timeout.ticks)) >= 0) {
   k_ticks_t ticks = (((k_ticks_t) -1) - 1 - (timeout.ticks)) - curr_tick;

   to->dticks = (((1) > (ticks)) ? (1) : (ticks));
  } else {
   to->dticks = timeout.ticks + 1 + elapsed();
  }

  for (t = first(); t != 
# 125 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                        ((void *)0)
# 125 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                            ; t = next(t)) {
  ...
  if (t == 
# 134 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
          ((void *)0)
# 134 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
              ) {
   sys_dlist_append(&timeout_list, &to->node);
  }

  if (to == first()) {
   sys_clock_set_timeout(next_timeout(), 
# 139 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                                        0
# 139 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                                             );
  }
 }
}
...
{
 int ret = -
# 146 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
           22
# 146 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                 ;
...
static k_ticks_t timeout_rem(const struct _timeout *timeout)
{
 ...
 for (struct _timeout *t = first(); t != 
# 167 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                                        ((void *)0)
# 167 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                                            ; t = next(t)) {
  ticks += t->dticks;
  if (timeout == t) {
   break;
...
int32_t z_get_next_timeout_expiry(void)
{
 int32_t ret = (int32_t) ((k_ticks_t) -1);
...
void sys_clock_announce(int32_t ticks)
{
 ...
 for (t = first();
      (t != 
# 230 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
           ((void *)0)
# 230 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
 ...
 if (t != 
# 244 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
         ((void *)0)
# 244 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
             ) {
  t->dticks -= announce_remaining;
 }
 ...
 sys_clock_set_timeout(next_timeout(), 
# 251 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                                      0
# 251 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                                           );
...
# 292 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
k_timepoint_t sys_timepoint_calc(k_timeout_t timeout)
{
 ...
 if (((timeout).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
  timepoint.tick = 
# 297 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                  (0xffffffffffffffffULL)
# 297 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                            ;
  ...
  if (1 && (((k_ticks_t) -1) - 1 - (dt)) >= 0) {
   timepoint.tick = (((k_ticks_t) -1) - 1 - (dt));
  } else {
   timepoint.tick = sys_clock_tick_get() + (((1) > (dt)) ? (1) : (dt));
  }
 }
...
k_timeout_t sys_timepoint_timeout(k_timepoint_t timepoint)
{
 ...
 if (timepoint.tick == 
# 317 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c" 3 4
                      (0xffffffffffffffffULL)
# 317 "/home/g/mise-work/zmk-firmware/zmk/zephyr/kernel/timeout.c"
                                ) {
  return ((k_timeout_t) { .ticks = (((k_ticks_t) -1)) });
 }
 if (timepoint.tick == 0) {
  return ((k_timeout_t) {0});
 }

 now = sys_clock_tick_get();
 remaining = (timepoint.tick > now) ? (timepoint.tick - now) : 0;
 return ((k_timeout_t) { .ticks = (remaining) });
}
