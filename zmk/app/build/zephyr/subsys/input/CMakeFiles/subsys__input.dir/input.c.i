# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 2


const 
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__aligned__(
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
__alignof(struct log_source_const_data)
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
))) 
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
struct log_source_const_data log_const_input __attribute__((section("." "_log_const" "." "static" "." "log_const_input_"))) 
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__used__)) 
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
= { .name = "input", .level = 3 }; extern const struct log_source_const_data log_const_input; extern struct log_source_dynamic_data log_dynamic_input; static const struct log_source_const_data * __log_current_const_data 
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
...
static char __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/zephyr/subsys/input/input.c\"" "." "0"))) 
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__aligned__(
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
4
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
))) 
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
_k_fifo_buf_input_msgq[(16) * (sizeof(struct input_event))]; 
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__aligned__(
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
struct k_msgq input_msgq __attribute__((section("." "_k_msgq" "." "static" "." "input_msgq_"))) 
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__used__)) 
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
= { .wait_q = { { {(&(&input_msgq.wait_q)->waitq)}, {(&(&input_msgq.wait_q)->waitq)} } }, .msg_size = (sizeof(struct input_event)), .max_msgs = (16), .buffer_start = _k_fifo_buf_input_msgq, .buffer_end = _k_fifo_buf_input_msgq + ((16) * (sizeof(struct input_event))), .read_ptr = _k_fifo_buf_input_msgq, .write_ptr = _k_fifo_buf_input_msgq, .used_msgs = 0, .poll_events = { {(&input_msgq.poll_events)}, {(&input_msgq.poll_events)} }, }
                                      ;
...
{
 extern struct input_listener _input_listener_list_start[]; extern struct input_listener _input_listener_list_end[]; for (struct input_listener * listener = _input_listener_list_start; ({ { }; listener < _input_listener_list_end; }); listener++) {
  if (listener->dev == 
# 24 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
                      ((void *)0) 
# 24 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
                           || listener->dev == evt->dev) {
...
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
_Bool 
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
    input_queue_empty(void)
{

 if (k_msgq_num_used_get(&input_msgq) > 0) {
  return 
# 34 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
        0
# 34 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
             ;
 }

 return 
# 37 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
       1
# 37 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
           ;
}

int input_report(const struct device *dev,
   uint8_t type, uint16_t code, int32_t value, 
# 41 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
                                              _Bool 
# 41 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
                                                   sync,
   k_timeout_t timeout)
{
...
static void input_thread(void)
{
 ...
 while (
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
       1
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
           ) {
  ret = k_msgq_get(&input_msgq, &evt, ((k_timeout_t) { .ticks = (((k_ticks_t) -1)) }));
  if (ret) {
   do { if (!(1 && ((1U <= 0) || ((0 == 
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  0
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
  ) && (1U <= __log_level) && (1U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "k_msgq_get error: %d" "\n", z_log_minimal_level_to_char(1U), ret); } while (
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  0
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
#pragma GCC diagnostic pop
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
   _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("k_msgq_get error: %d" == 
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  ((void *)0)
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
  ) { _plen = 0; } else { do {
...
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  28
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
  ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("k_msgq_get error: %d") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("k_msgq_get error: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("k_msgq_get error: %d") + 0))) > (1)) ? (_Generic(("k_msgq_get error: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("k_msgq_get error: %d") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("k_msgq_get error: %d") + 0; (void)__v; size_t __arg_size = _Generic(("k_msgq_get error: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("k_msgq_get error: %d") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("k_msgq_get error: %d") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("k_msgq_get error: %d") + 0; double _d = _Generic(("k_msgq_get error: %d") + 0, float : ("k_msgq_get error: %d") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("k_msgq_get error: %d") + 0; (void)__v; size_t __arg_size = _Generic(("k_msgq_get error: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("k_msgq_get error: %d") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("k_msgq_get error: %d") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "k_msgq_get error: %d"; } } while (
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  0
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  0
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
  ) { z_log_printf_arg_checker("k_msgq_get error: %d", ret); } } while (
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
  0
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
  );
...
struct z_thread_stack_element __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/zephyr/subsys/input/input.c\"" "." "1"))) 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__aligned__(
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
8
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
))) 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
_k_thread_stack_input[(((((unsigned long)(512) + ((unsigned long)(8) - 1)) / (unsigned long)(8)) * (unsigned long)(8)) + ((size_t)0))]; struct k_thread _k_thread_obj_input; 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__aligned__(
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
__alignof(struct _static_thread_data)
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
))) 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
struct _static_thread_data _k_thread_data_input __attribute__((section("." "__static_thread_data" "." "static" "." "_k_thread_data_input_"))) 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
__attribute__((__used__)) 
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
= { .init_thread = (&_k_thread_obj_input), .init_stack = (_k_thread_stack_input), .init_stack_size = (512), .init_entry = (k_thread_entry_t)input_thread, .init_p1 = (void *)
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
((void *)0)
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
, .init_p2 = (void *)
...
((void *)0)
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
, .init_prio = (0), .init_options = (0), .init_name = "input", .init_delay = ((k_timeout_t) { .ticks = ((0) == (-1) ? ((k_ticks_t) -1) : ((k_ticks_t)((
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c" 3 4
1
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
...
1
# 82 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/input/input.c"
) ? (1000) - 1 : 0)) / (1000)) ))) }) }; const k_tid_t input = (k_tid_t)&_k_thread_obj_input
