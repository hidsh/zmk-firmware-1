# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 2
...
int bt_le_per_adv_set_response_data(struct bt_le_per_adv_sync *per_adv_sync,
        ...
        const struct net_buf_simple *data);
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 2
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 2
const 
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
__attribute__((__aligned__(
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
__alignof(struct log_source_const_data)
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
))) 
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
struct log_source_const_data log_const_bt_data __attribute__((section("." "_log_const" "." "static" "." "log_const_bt_data_"))) 
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
__attribute__((__used__)) 
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
= { .name = "bt_data", .level = 3 }; extern const struct log_source_const_data log_const_bt_data; extern struct log_source_dynamic_data log_dynamic_bt_data; static const struct log_source_const_data * __log_current_const_data 
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
...
# 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
    _Bool 
# 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
         (*func)(struct bt_data *data, void *user_data),
     void *user_data)
{
 while (ad->len > 1) {
  ...
  if (len > ad->len) {
   do { if (!(1 && ((2U <= 0) || ((0 == 
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  0
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  ) && (2U <= __log_level) && (2U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "malformed advertising data %u / %u" "\n", z_log_minimal_level_to_char(2U), len, ad->len); } while (
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  0
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
...
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
   ; __auto_type _v1 = (len) + 0 ; __auto_type _v2 = (ad->len) + 0;
#pragma GCC diagnostic pop
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
   do { ; 
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
...
#pragma GCC diagnostic pop
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
   _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("malformed advertising data %u / %u" == 
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  ((void *)0)
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  ) { _plen = 0; } else { do {
...
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  28
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("malformed advertising data %u / %u") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("malformed advertising data %u / %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("malformed advertising data %u / %u") + 0))) > (1)) ? (_Generic(("malformed advertising data %u / %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("malformed advertising data %u / %u") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("malformed advertising data %u / %u") + 0; (void)__v; size_t __arg_size = _Generic(("malformed advertising data %u / %u"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("malformed advertising data %u / %u") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("malformed advertising data %u / %u") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("malformed advertising data %u / %u") + 0; double _d = _Generic(("malformed advertising data %u / %u") + 0, float : ("malformed advertising data %u / %u") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("malformed advertising data %u / %u") + 0; (void)__v; size_t __arg_size = _Generic(("malformed advertising data %u / %u"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("malformed advertising data %u / %u") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("malformed advertising data %u / %u") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "malformed advertising data %u / %u"; } } while (
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  0
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
...
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  0
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  ) { z_log_printf_arg_checker("malformed advertising data %u / %u", len, ad->len); } } while (
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
  0
# 31 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  )
...
{
 if (input == 
# 61 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
((void *)0)
# 61 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "input is NULL" "\n", z_log_minimal_level_to_char(4U)); } while (
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
...
#pragma GCC diagnostic pop
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "input is NULL" == 
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 ((void *)0)
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) { _plen = 0; } else { do {
...
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 28
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "input is NULL") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "input is NULL") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "input is NULL") + 0))) > (1)) ? (_Generic(("%s: " "input is NULL") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "input is NULL") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "input is NULL") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "input is NULL"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "input is NULL") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "input is NULL") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "input is NULL") + 0; double _d = _Generic(("%s: " "input is NULL") + 0, float : ("%s: " "input is NULL") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "input is NULL") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "input is NULL"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "input is NULL") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "input is NULL") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "input is NULL"; } } while (
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) { z_log_printf_arg_checker("input is NULL"); } } while (
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 62 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 );
 ...
 if (output == 
# 66 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
((void *)0)
# 66 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "output is NULL" "\n", z_log_minimal_level_to_char(4U)); } while (
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ); break; } if (0 != 0 && !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic pop
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
  _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "output is NULL" == 
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 ((void *)0)
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) { _plen = 0; } else { do {
...
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 28
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "output is NULL") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "output is NULL") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "output is NULL") + 0))) > (1)) ? (_Generic(("%s: " "output is NULL") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "output is NULL") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "output is NULL") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "output is NULL"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "output is NULL") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "output is NULL") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "output is NULL") + 0; double _d = _Generic(("%s: " "output is NULL") + 0, float : ("%s: " "output is NULL") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "output is NULL") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "output is NULL"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "output is NULL") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "output is NULL") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "output is NULL"; } } while (
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 ) { z_log_printf_arg_checker("output is NULL"); } } while (
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
 0
# 67 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
 );
...
# 77 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
((__builtin_object_size(
# 77 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
&output[2]
# 77 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c" 3 4
, 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 77 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/data.c"
