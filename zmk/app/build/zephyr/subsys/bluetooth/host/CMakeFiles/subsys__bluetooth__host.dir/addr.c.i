# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2

# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/bluetooth/addr.h" 1
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/bluetooth/addr.h"
...
# 15 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 2
...
int bt_addr_from_str(const char *str, bt_addr_t *addr)
{
 ...
 if (len != 18 - 1) {
  return -
# 64 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 3 4
         22
# 64 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
               ;
 }
 ...
 for (size_t i = 2; i < len; i += 3) {
  if (str[i] != ':') {
   return -
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 3 4
          22
# 70 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
                ;
  }
 }
 ...
 for (size_t i = 0; i < ((size_t) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(addr->val), __typeof__(&(addr->val)[0])))]) - 1) + (sizeof(addr->val) / sizeof((addr->val)[0])))); i++) {
  const size_t reverse_i = ((size_t) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(addr->val), __typeof__(&(addr->val)[0])))]) - 1) + (sizeof(addr->val) / sizeof((addr->val)[0])))) - 1 - i;

  if (!hex2bin(&str[i * 3], 2, &addr->val[reverse_i], 1)) {
   return -
# 81 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 3 4
          22
# 81 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
                ;
  }
 }
...
int bt_addr_le_from_str(const char *str, const char *type, bt_addr_le_t *addr)
{
 ...
 if (!strcmp(type, "public") || !strcmp(type, "(public)")) {
  ...
  return -
# 106 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 3 4
         22
# 106 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
               ;
 }
...
# 119 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c" 3 4
_Bool 
# 119 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/host/addr.c"
    bt_addr_le_is_resolved(const bt_addr_le_t *addr)
{
 return (addr->type & (0x02)) != 0;
}
