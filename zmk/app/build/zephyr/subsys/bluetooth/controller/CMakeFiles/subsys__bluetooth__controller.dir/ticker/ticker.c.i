# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cpu.h" 2
...
# 15 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
uint8_t ticker_update_ext(uint8_t instance_index, uint8_t user_id,
      ...
      ticker_op_func fp_op_func, void *op_context,
      uint8_t must_expire);
# 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
...
# 19 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 2
# 47 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
struct ticker_node {
 uint8_t next;
 ...
 uint8_t must_expire;
# 114 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
};
...
# 158 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
struct ticker_user_op_update {
 ...
 uint8_t must_expire;
# 214 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
};
...
# 326 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
_Static_assert(sizeof(struct ticker_node) == 48, "" );
_Static_assert(sizeof(struct ticker_user) == 8, "" );
_Static_assert(sizeof(struct ticker_user_op) == 48, "" );





static struct ticker_instance _instance[1];
...
# 363 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 447 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
        ...
        uint16_t *lazy)
{
 ...
 if ((_ticker_id_head == ((uint8_t)((uint8_t)0 - 1))) ||
 ...
 while (_ticker_id_head != ((uint8_t)((uint8_t)0 - 1))) {
  ticker = &node[_ticker_id_head];
...
# 549 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
static uint8_t ticker_enqueue(struct ticker_instance *instance, uint8_t id)
{
 ...
 previous = ((uint8_t)((uint8_t)0 - 1));

 while ((current != ((uint8_t)((uint8_t)0 - 1))) && (ticks_to_expire >=
 ...
 if (previous == ((uint8_t)((uint8_t)0 - 1))) {
  instance->ticker_id_head = id;
 } else {
  node[previous].next = id;
 }

 if (current != ((uint8_t)((uint8_t)0 - 1))) {
  node[current].ticks_to_expire -= ticks_to_expire;
 }

 return id;
}
# 718 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
static uint32_t ticker_dequeue(struct ticker_instance *instance, uint8_t id)
{
 ...
 total = 0U;
 ticker_current = 0;
 while (current != ((uint8_t)((uint8_t)0 - 1))) {
 ...
 if (ticker_current->next != ((uint8_t)((uint8_t)0 - 1))) {
  node[ticker_current->next].ticks_to_expire += timeout;
 }

 return (total + timeout);
}
# 799 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
         ...
         struct ticker_node *ticker)
{
 ...
 if (ticker->next != ((uint8_t)((uint8_t)0 - 1))) {
  ...
  if (((ticker)->ext_data && ((ticker)->ext_data->ticks_slot_window != 0U)) && !ticker->ticks_slot) {
   ticker_ticks_slot = ( ((uint32_t)(((uint64_t) (150) * 1000000000UL) / 30517578125UL)) & 0x00FFFFFF );
  } else {
  ...
  while (id_head != ((uint8_t)((uint8_t)0 - 1))) {
...
# 895 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
   uint8_t next_is_critical = 0U;
   uint8_t equal_priority = 1U;
   uint8_t next_has_priority = 0U;
# 940 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
   ...
   uint8_t curr_has_ticks_slot_window =
    (((ticker)->ext_data && ((ticker)->ext_data->ticks_slot_window != 0U)) &&
     !ticker->ticks_slot &&
     ((acc_ticks_to_expire +
       ticker_next->ticks_slot) <
      (ticker->ext_data->ticks_slot_window)));
# 972 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 1213 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
void ticker_worker(void *param)
{
 ...
 if (instance->ticker_id_head == ((uint8_t)((uint8_t)0 - 1))) {
 ...
 while (ticker_id_head != ((uint8_t)((uint8_t)0 - 1))) {
  struct ticker_node *ticker;
  uint32_t ticks_to_expire;
  ...
  if (((ticker->ticks_slot != 0U) ||
   ...
   if ((ticker->must_expire == 0U) ||
       (ticker->lazy_periodic >= ticker->lazy_current) ||
       (ticker->ext_data && (ticker->ext_data->reschedule_state == 1))) {
...
# 1360 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
  ticker->ack--;
  ...
  if (ticker->timeout_func) {
   ...
   ticks_at_expire = (instance->ticks_current +
        ...
        0x00FFFFFF;
# 1403 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
   {
    ;
 ...
 instance->sched_cb(3, 4, 1,
      instance);
}
# 1463 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
     ...
     uint32_t ticks_current, uint32_t ticks_at_start)
{
 ...
 if (!((ticks_at_start - ticks_current) & (1UL << (23)))) {
...
# 1530 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
static inline uint8_t ticker_add_to_remainder(uint32_t *remainder, uint32_t to_add)
{

 *remainder += to_add;
 if ((*remainder < (1UL << (31))) &&
     (*remainder > (( ((uint32_t)(((uint64_t)(1000000UL) * 30517578125UL) / 1000000000UL)) ) >> 1))) {
  *remainder -= ( ((uint32_t)(((uint64_t)(1000000UL) * 30517578125UL) / 1000000000UL)) );
  return 1;
 }
 return 0;
...
# 1558 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 1576 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
static uint8_t ticker_remainder_dec(struct ticker_node *ticker)
{

 uint8_t decrement = 0U;

 if ((ticker->remainder_current >= (1UL << (31))) ||
     (ticker->remainder_current <= (( ((uint32_t)(((uint64_t)(1000000UL) * 30517578125UL) / 1000000000UL)) ) >> 1))) {
  decrement++;
  ticker->remainder_current += ( ((uint32_t)(((uint64_t)(1000000UL) * 30517578125UL) / 1000000000UL)) );
 }
...
# 1601 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 1624 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 1732 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 ticker->next = *insert_head;
 *insert_head = user_op->id;

 return 0;
}
# 1753 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
       ...
       uint8_t *insert_head)
{
 ...
 if (1 &&
  ...
  ticker_job_node_update(instance, ticker, user_op, ticks_now,
           ...
           insert_head);
# 1778 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
  ticker->req++;
 } else {
  ...
  if (user_op->op != 6) {
   ...
   ticker->ticks_to_expire = ticker_dequeue(instance,
         user_op->id);
# 1796 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
  ...
  if (instance->ticker_id_slot_previous == user_op->id) {
   ...
   if (user_op->op != 6) {
    instance->ticker_id_slot_previous = ((uint8_t)((uint8_t)0 - 1));
   }
 ...
 ticker_job_op_cb(user_op, 0);
}
# 1865 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
          ...
          uint8_t *insert_head)
{
 ...
 while (count_user--) {
  ...
  while (user->middle != user->last) {
   ...
   if (user_op->op < 5) {
# 1921 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
    continue;
   }
...
# 1998 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
     ...
     uint8_t *insert_head)
{
 ...
 node = &instance->nodes[0];
 ticks_expired = 0U;
 while (instance->ticker_id_head != ((uint8_t)((uint8_t)0 - 1))) {
  ...
  if ((ticker->ticks_periodic != 0U) ||
   ...
   if ((ticker->ext_data && (ticker->ext_data->reschedule_state == 1))) {
...
# 2174 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
   ticker->next = *insert_head;
...
# 2209 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
        ...
        uint32_t ticks_current)
{
 ...
 if (start->lazy != 0xFFFE) {

  ticker->must_expire =
   (start->lazy == 0xFFFF) ? 1U : 0U;
 }
...
# 2249 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 ticker->ticks_periodic = start->ticks_periodic;
 ticker->remainder_periodic = start->remainder_periodic;
 ticker->lazy_periodic =
  (start->lazy < 0xFFFE) ? start->lazy :
              0U;
...
# 2289 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
          ...
          uint8_t *insert_head)
{
 ...
 ticker->next = ((uint8_t)((uint8_t)0 - 1));
...
# 2325 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
         ...
         uint32_t ticks_elapsed)
{
 ...
 while (rescheduling) {
  ...
  ticker_id_resched_prev = ((uint8_t)((uint8_t)0 - 1));
  ticker_id_resched = instance->ticker_id_head;
  while (ticker_id_resched != ((uint8_t)((uint8_t)0 - 1))) {
   ticker_resched = &nodes[ticker_id_resched];
   if ((ticker_resched->ext_data && (ticker_resched->ext_data->reschedule_state == 1))) {
  ...
  if (ticker_id_resched == ((uint8_t)((uint8_t)0 - 1))) {
...
# 2392 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
  ...
  if (ext_data->ticks_drift < ext_data->ticks_slot_window) {
   ...
   ticker_id_next = ((uint8_t)((uint8_t)0 - 1));
  ...
  if (ticker_resched->ticks_slot) {
   ...
   do { if (!(((ticker_resched)->ext_data && ((ticker_resched)->ext_data->ticks_slot_window != 0U)))) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "((ticker_resched)->ext_data && ((ticker_resched)->ext_data->ticks_slot_window != 0U))", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ticker/ticker.c", 2410); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 2410 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
  0
# 2410 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
  ); } } while (0);

   ticks_slot = ( ((uint32_t)(((uint64_t) (150) * 1000000000UL) / 30517578125UL)) & 0x00FFFFFF );
  }
  ...
  ticks_to_expire = 0U;
  while ((ticker_id_next != ((uint8_t)((uint8_t)0 - 1))) &&
   ...
   if ((ticker_next->ext_data && (ticker_next->ext_data->reschedule_state == 1)) ||
       !ticker_next->ticks_slot ||
       !ticker_next->ticks_periodic) {
   ...
   if (ticks_to_expire_offset >
       ( ((uint32_t)(((uint64_t) (150) * 1000000000UL) / 30517578125UL)) & 0x00FFFFFF )) {
    window_end_ticks =
     (((ticks_slot_window) < (ticks_start_offset + ticks_to_expire_offset - ( ((uint32_t)(((uint64_t) (150) * 1000000000UL) / 30517578125UL)) & 0x00FFFFFF ))) ? (ticks_slot_window) : (ticks_start_offset + ticks_to_expire_offset - ( ((uint32_t)(((uint64_t) (150) * 1000000000UL) / 30517578125UL)) & 0x00FFFFFF )))
  ...
  ticker_id_next = ticker_resched->next;
  ticker_id_prev = ((uint8_t)((uint8_t)0 - 1));
  while (ticker_id_next != ((uint8_t)((uint8_t)0 - 1))) {
   struct ticker_node *ticker_next;
  ...
  if (ticker_id_prev != ((uint8_t)((uint8_t)0 - 1))) {

   if (ticker_id_resched_prev != ((uint8_t)((uint8_t)0 - 1))) {
...
# 2704 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
       ...
       uint8_t insert_head)
{
 ...
 while (count_user--) {
  ...
  while ((insert_head != ((uint8_t)((uint8_t)0 - 1))) ||
   ...
   if (insert_head != ((uint8_t)((uint8_t)0 - 1))) {
    ...
    user_op = 
# 2740 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
             ((void *)0)
# 2740 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
                 ;
   } else {
...
# 2808 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 }
}
# 2822 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
      ...
      struct ticker_user_op *uop)
{
 ...
 fp_op_func = 
# 2827 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
             ((void *)0)
# 2827 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
                 ;
 switch (uop->op) {
...
# 2849 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
    ((void *)0)
# 2849 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
        );
 ...
 case 1:
  ...
  break;
# 2884 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 default:
...
# 2908 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 2953 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
     ...
     uint8_t ticker_id_old_head)
{
 ...
 if (ticker_id_old_head == ((uint8_t)((uint8_t)0 - 1))) {
  uint32_t ticks_current;
 ...
 do {
  ...
  do { if (!(i)) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "i", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ticker/ticker.c", 3009); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 3009 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
 0
# 3009 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 ); } } while (0);
  i--;
  ...
  ticks_elapsed = ticks_diff + 3 +
    0;
  cc += (((ticks_elapsed) > (ticks_to_expire)) ? (ticks_elapsed) : (ticks_to_expire));
  cc &= 0x00FFFFFF;
...
# 3052 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
void ticker_job(void *param)
{
 struct ticker_instance *instance = param;
 ...
 insert_head = ((uint8_t)((uint8_t)0 - 1));
...
# 3172 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 ...
 if (instance->worker_trigger || compare_trigger) {
  instance->sched_cb(4, 3, 1,
       instance);
 }

 ;
}
# 3218 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_init(uint8_t instance_index, uint8_t count_node, void *node,
    ...
    ticker_trigger_set_cb_t trigger_set_cb)
{
 ...
 instance->nodes = node;
# 3246 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 ...
 instance->ticker_id_head = ((uint8_t)((uint8_t)0 - 1));
 instance->ticks_current = cntr_cnt_get();
 ...
 instance->ticker_id_slot_previous = ((uint8_t)((uint8_t)0 - 1));
 instance->ticks_slot_previous = 0U;
# 3283 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
 return 0;
}
# 3293 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"

# 3293 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
_Bool 
# 3293 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
    ticker_is_initialized(uint8_t instance_index)
{
...
# 3306 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
void ticker_trigger(uint8_t instance_index)
{
...
# 3355 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
...
# 3366 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
   ((void *)0)
# 3366 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
       );
}
...
# 3392 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
  ((void *)0)
# 3392 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
      );
}
...
static uint8_t start_us(uint8_t instance_index, uint8_t user_id,
   ...
   ticker_op_func fp_op_func, void *op_context,
   struct ticker_ext *ext_data)
# 3445 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
{
 struct ticker_instance *instance = &_instance[instance_index];
 struct ticker_user_op *user_op;
 struct ticker_user *user;
...
# 3529 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_update(uint8_t instance_index, uint8_t user_id,
         uint8_t ticker_id, uint32_t ticks_drift_plus,
         uint32_t ticks_drift_minus, uint32_t ticks_slot_plus,
         uint32_t ticks_slot_minus, uint16_t lazy, uint8_t force,
         ticker_op_func fp_op_func, void *op_context)
# 3551 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
{
...
# 3637 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_yield_abs(uint8_t instance_index, uint8_t user_id,
     uint8_t ticker_id, uint32_t ticks_at_yield,
     ticker_op_func fp_op_func, void *op_context)
{
...
# 3693 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_stop(uint8_t instance_index, uint8_t user_id, uint8_t ticker_id,
    ticker_op_func fp_op_func, void *op_context)
{
 struct ticker_instance *instance = &_instance[instance_index];
...
# 3748 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_stop_abs(uint8_t instance_index, uint8_t user_id,
    uint8_t ticker_id, uint32_t ticks_at_stop,
    ticker_op_func fp_op_func, void *op_context)
{
...
# 3810 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint8_t ticker_next_slot_get(uint8_t instance_index, uint8_t user_id,
         uint8_t *ticker_id, uint32_t *ticks_current,
         uint32_t *ticks_to_expire,
         ticker_op_func fp_op_func, void *op_context)
...
# 3819 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
                                    ((void *)0)
# 3819 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
                                        ,
     
# 3820 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
    ((void *)0)
# 3820 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
        , 
# 3820 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c" 3 4
          ((void *)0)
# 3820 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
      ...
      ticker_op_func fp_op_func, void *op_context)
{
 ...
 user_op = &user->user_op[user->last];
 user_op->op = 2;
 user_op->id = ((uint8_t)((uint8_t)0 - 1));
...
# 4011 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
void ticker_job_sched(uint8_t instance_index, uint8_t user_id)
{
 struct ticker_instance *instance = &_instance[instance_index];
...
# 4038 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ticker/ticker.c"
uint32_t ticker_ticks_diff_get(uint32_t ticks_now, uint32_t ticks_old)
{
