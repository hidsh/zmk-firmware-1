# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2

# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/swi.h" 1
# 40 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/swi.h"
...
{
 __NVIC_SetPendingIRQ(SWI4_EGU4_IRQn);
}

static inline void hal_swi_worker_pend(void)
{
 __NVIC_SetPendingIRQ(RTC0_IRQn);
}
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2
...
# 18 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 2
...
void mayfly_enable_cb(uint8_t caller_id, uint8_t callee_id, uint8_t enable)
{
 ...
 case 1:
  if (enable) {
   arch_irq_enable(RTC0_IRQn);
  } else {
   arch_irq_disable(RTC0_IRQn);
  }
  break;
 ...
 default:
  do { if (!(0)) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "0", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c", 45); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 45 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 3 4
 0
# 45 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
 ); } } while (0);
  break;
 }
}
...
uint32_t mayfly_is_enabled(uint8_t caller_id, uint8_t callee_id)
{
 ...
 switch (callee_id) {
 case 0:
  return arch_irq_is_enabled(SWI4_EGU4_IRQn);

 case 1:
  return arch_irq_is_enabled(RTC0_IRQn);

 case 2:
  return arch_irq_is_enabled(RTC0_IRQn);

 default:
  do { if (!(0)) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "0", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c", 65); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 65 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 3 4
 0
# 65 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
 ); } } while (0);
  break;
 }
...
uint32_t mayfly_prio_is_equal(uint8_t caller_id, uint8_t callee_id)
{
 return 0 ||
  ...
  (caller_id == callee_id) ||
# 97 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
        ((caller_id == 1) &&
  (callee_id == 2)) ||
        ((caller_id == 2) &&
  (callee_id == 1)) ||
...
void mayfly_pend(uint8_t caller_id, uint8_t callee_id)
{
 ...
 default:
  do { if (!(0)) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "0", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c", 123); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 123 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c" 3 4
 0
# 123 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/mayfly.c"
 ); } } while (0);
  break;
 }
}
