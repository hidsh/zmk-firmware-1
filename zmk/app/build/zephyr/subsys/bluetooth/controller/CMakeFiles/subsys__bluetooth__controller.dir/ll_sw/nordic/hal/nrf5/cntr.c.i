# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c"
...
# 37 "/home/g/mise-work/zmk-firmware/zmk/modules/hal/nordic/nrfx/hal/nrf_rtc.h"
...
# 38 "/home/g/mise-work/zmk-firmware/zmk/modules/hal/nordic/nrfx/hal/nrf_rtc.h" 2
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c" 2
...
void cntr_init(void)
{
 ((NRF_RTC_Type*) 0x4000B000UL)->PRESCALER = 0;
 nrf_rtc_event_enable(((NRF_RTC_Type*) 0x4000B000UL), (0x1UL << (16UL)));
 nrf_rtc_int_enable(((NRF_RTC_Type*) 0x4000B000UL), (0x1UL << (16UL)));
}
...
uint32_t cntr_start(void)
{
 ...
 nrf_rtc_task_trigger(((NRF_RTC_Type*) 0x4000B000UL), NRF_RTC_TASK_START);
...
uint32_t cntr_stop(void)
{
 do { if (!(_refcount)) { assert_print("ASSERTION FAIL [%s] @ %s:%d\n", "_refcount", "WEST_TOPDIR/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c", 40); do { __asm__ volatile ( "eors.n r0, r0\n\t" "msr BASEPRI, r0\n\t" "mov r0, %[reason]\n\t" "svc %[id]\n\t" : : [reason] "i" (K_ERR_KERNEL_OOPS), [id] "i" (2) : "memory"); } while (
# 40 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c" 3 4
0
# 40 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/controller/ll_sw/nordic/hal/nrf5/cntr.c"
); } } while (0);
 ...
 nrf_rtc_task_trigger(((NRF_RTC_Type*) 0x4000B000UL), NRF_RTC_TASK_STOP);
...
uint32_t cntr_cnt_get(void)
{
 return nrf_rtc_counter_get(((NRF_RTC_Type*) 0x4000B000UL));
}

void cntr_cmp_set(uint8_t cmp, uint32_t value)
{
 nrf_rtc_cc_set(((NRF_RTC_Type*) 0x4000B000UL), cmp, value);
}
