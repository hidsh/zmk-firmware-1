...
.Ltext0:
	...
	.file 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/usb/device/usb_work_q.c"
	.section	.rodata.z_usb_work_q_init.str1.1,"aMS",%progbits,1
.LC0:
	.ascii	"usbworkq\000"
	.section	.text.z_usb_work_q_init,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.type	z_usb_work_q_init, %function
z_usb_work_q_init:
.LFB444:
	.loc 1 18 1 view -0
	.cfi_startproc
...
.LVL0:
	.loc 1 24 2 is_stmt 1 view .LVU4
.LBB4:
.LBI4:
	.file 2 "/home/g/mise-work/zmk-firmware/zmk/app/build/zephyr/include/generated/syscalls/kernel.h"
	.loc 2 426 19 view .LVU5
.LBB5:
	.loc 2 435 2 view .LVU6
	.loc 2 435 7 view .LVU7
	.loc 2 435 5 view .LVU8
	.loc 2 436 2 view .LVU9
	.loc 2 436 9 is_stmt 0 view .LVU10
	ldr	r1, .L2+8
	mov	r0, r5
	bl	z_impl_k_thread_name_set
.LVL1:
	.loc 2 436 9 view .LVU11
.LBE5:
.LBE4:
	.loc 1 26 2 is_stmt 1 view .LVU12
	.loc 1 27 1 is_stmt 0 view .LVU13
	mov	r0, r4
	add	sp, sp, #12
...
.L2:
	.word	z_usb_work_q
	.word	z_usb_work_q_stack
	.word	.LC0
	.cfi_endproc
.LFE444:
	.size	z_usb_work_q_init, .-z_usb_work_q_init
	.section	.z_init_POST_KERNEL40_0_,"a"
	.align	2
	.type	__init_z_usb_work_q_init, %object
	.size	__init_z_usb_work_q_init, 8
__init_z_usb_work_q_init:
	.word	z_usb_work_q_init
	.word	0
	.global	z_usb_work_q
	.section	.bss.z_usb_work_q,"aw",%nobits
	.align	3
	.type	z_usb_work_q, %object
	.size	z_usb_work_q, 232
z_usb_work_q:
	.space	232
	.global	z_usb_work_q_stack
	.section	.noinit."WEST_TOPDIR/zephyr/subsys/usb/device/usb_work_q.c".0,"aw"
	.align	3
	.type	z_usb_work_q_stack, %object
	.size	z_usb_work_q_stack, 1024
z_usb_work_q_stack:
	.space	1024
	.text
.Letext0:
	...
	.file 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/kernel/thread_stack.h"
	...
	.file 18 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/usb/device/usb_work_q.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	__init_z_usb_work_q_init
	.uleb128 0x26
	.4byte	.LASF138
	.byte	0x2
	.2byte	0x1a7
...
.LASF133:
	...
	.ascii	"b/device/usb_work_q.c\000"
.LASF57:
...
.LASF81:
	.ascii	"preempt\000"
.LASF131:
	.ascii	"__init_z_usb_work_q_init\000"
.LASF118:
