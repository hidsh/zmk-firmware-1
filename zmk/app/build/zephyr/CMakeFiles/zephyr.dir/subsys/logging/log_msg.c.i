# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 7 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/syscall_handler.h" 1
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 2
extern const struct log_source_const_data log_const_log; extern struct log_source_dynamic_data log_dynamic_log; static const struct log_source_const_data * __log_current_const_data __attribute__((__unused__)) = 1 ? &log_const_log : 
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
((void *)0)
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
; static struct log_source_dynamic_data * __log_current_dynamic_data __attribute__((__unused__)) = (1 && 0) ? &log_dynamic_log : 
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
((void *)0)
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
; static const uint32_t __log_level __attribute__((__unused__)) = 3;

_Static_assert(sizeof(struct log_msg_desc) == sizeof(uint32_t), "" "Descriptor must fit in 32 bits")
                                       ;
    ...
    const struct log_msg_desc desc, const void *data)
{
 if (!msg) {
  z_log_dropped(
# 27 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
               0
# 27 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                    );
...
# 35 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 ((__builtin_object_size(
# 35 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
 d
# 35 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 35 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
         ...
         uint8_t *package, const void *data)
{
 ...
 if (!!(0 && (0 || log_backend_count_get() == 0))) {
  return;
 }
...
# 69 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
        ((void *)0)
# 69 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
            , 0, flags,
         strl, ((size_t) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(strl), __typeof__(&(strl)[0])))]) - 1) + (sizeof(strl) / sizeof((strl)[0])))));
  ...
  if (len > ((1UL << (11)) - 1UL)) {
   ...
   do { if (!(1 && ((2U <= 0) || ((0 == 
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  0
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
  ) && (2U <= __log_level) && (2U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Message (\"%s\") dropped because it exceeds size limitation (%u)" "\n", z_log_minimal_level_to_char(2U), pkg->fmt, (uint32_t)((1UL << (11)) - 1UL)); } while (
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  0
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
   ; __auto_type _v1 = (pkg->fmt) + 0 ; __auto_type _v2 = ((uint32_t)((1UL << (11)) - 1UL)) + 0;
#pragma GCC diagnostic pop
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
   do { ; 
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
...
#pragma GCC diagnostic pop
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
   _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Message (\"%s\") dropped because it exceeds size limitation (%u)" == 
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  ((void *)0)
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
  ) { _plen = 0; } else { do {
...
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  28
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
  ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0))) > (1)) ? (_Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0; (void)__v; size_t __arg_size = _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0; double _d = _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, float : ("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0; (void)__v; size_t __arg_size = _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Message (\"%s\") dropped because it exceeds size limitation (%u)") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Message (\"%s\") dropped because it exceeds size limitation (%u)"; } } while (
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  0
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  0
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
  ) { z_log_printf_arg_checker("Message (\"%s\") dropped because it exceeds size limitation (%u)", pkg->fmt, (uint32_t)((1UL << (11)) - 1UL)); } } while (
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
  0
# 76 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
  )
  ...
  if (msg) {
   len = cbprintf_package_copy(package, inlen,
          ...
          flags, strl, ((size_t) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(strl), __typeof__(&(strl)[0])))]) - 1) + (sizeof(strl) / sizeof((strl)[0])))));
   { };
  }
 } else {
  msg = z_log_msg_alloc(log_msg_get_total_wlen(out_desc));
...
# 108 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 117 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 __builtin_va_copy(
# 117 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
 ap2
# 117 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 ,
# 117 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 117 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                 ;
  plen = cbvprintf_package(
# 118 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                          ((void *)0)
# 118 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                              , 
# 118 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                                __builtin_offsetof (
# 118 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 121 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 __builtin_va_end(
# 121 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
 ap2
# 121 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
 )
# 121 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
 ...
 size_t msg_wlen = (((((((unsigned long)((
# 126 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                  __builtin_offsetof (
# 126 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                  struct log_msg
# 126 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                  , 
# 126 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
...
# 126 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                  + plen + (dlen))) + ((unsigned long)((((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) <= 2UL ? ((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) : (1UL << (8 * sizeof(long) - __builtin_clzl(((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) - 1))))) - 1)) / (unsigned long)((((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) <= 2UL ? ((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) : (1UL << (8 * sizeof(long) - __builtin_clzl(((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) - 1)))))) * (unsigned long)((((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) <= 2UL ? ((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) : (1UL << (8 * sizeof(long) - __builtin_clzl(((((sizeof(double)) > (sizeof(long long))) ? (sizeof(double)) : (sizeof(long long)))) - 1))))))) + (sizeof(uint32_t)) - 1) / (sizeof(uint32_t)));
 struct log_msg *msg;
 uint8_t *pkg;
 struct log_msg_desc desc =
  { .valid = 0, .busy = 0, .type = 0, .domain = domain_id, .level = level, .package_len = plen, .data_len = dlen, };

 if (1 && !(0 && (0 || log_backend_count_get() == 0))) {
  msg = z_log_msg_alloc(msg_wlen);
  if (0 && msg == 
# 134 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                                               ((void *)0)
# 134 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                                                   ) {
   pkg = __builtin_alloca(plen);
  } else {
   pkg = msg ? msg->data : 
# 137 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c" 3 4
                          ((void *)0)
# 137 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/logging/log_msg.c"
                              ;
  }
 } else {
  msg = __builtin_alloca(msg_wlen * sizeof(int));
  pkg = msg->data;
 }
