# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
# 1 "/home/g/zephyr-sdk-0.16.3/arm-zephyr-eabi/lib/gcc/arm-zephyr-eabi/12.2.0/include/stddef.h" 1 3 4
# 15 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 18 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 19 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 21 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
int bt_le_per_adv_set_response_data(struct bt_le_per_adv_sync *per_adv_sync,
        ...
        const struct net_buf_simple *data);
# 23 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 24 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 26 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 27 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
...
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 2
const 
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
__attribute__((__aligned__(
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
__alignof(struct log_source_const_data)
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
))) 
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
struct log_source_const_data log_const_bt_dis __attribute__((section("." "_log_const" "." "static" "." "log_const_bt_dis_"))) __attribute__((__used__)) = { .name = "bt_dis", .level = 3 }; extern const struct log_source_const_data log_const_bt_dis; extern struct log_source_dynamic_data log_dynamic_bt_dis; static const struct log_source_const_data * __log_current_const_data __attribute__((__unused__)) = 1 ? &log_const_bt_dis : 
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
; static struct log_source_dynamic_data * __log_current_dynamic_data __attribute__((__unused__)) = (1 && 0) ? &log_dynamic_bt_dis : 
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 30 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
...
# 38 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
 __attribute__((__packed__))
# 38 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
         ;
...
# 86 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
...
const struct bt_gatt_attr attr_dis_svc[] = { { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2800), }})), .read = bt_gatt_attr_read_service, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x180a), }})), .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), }})), .read = bt_gatt_attr_read_chrc, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = ((struct bt_gatt_chrc[]) { { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a24), }})), .value_handle = 0U, .properties = 0x02, }, }), .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a24), }})), .read = read_str, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = "DYNAMIC_PINCTLS", .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), }})), .read = bt_gatt_attr_read_chrc, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = ((struct bt_gatt_chrc[]) { { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a29), }})), .value_handle = 0U, .properties = 0x02, }, }), .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a29), }})), .read = read_str, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = "ZMK Project", .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), }})), .read = bt_gatt_attr_read_chrc, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = ((struct bt_gatt_chrc[]) { { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a50), }})), .value_handle = 0U, .properties = 0x02, }, }), .handle = 0, .perm = BT_GATT_PERM_READ, }, { .uuid = ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2a50), }})), .read = read_pnp_id, .write = 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
((void *)0)
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
, .user_data = &dis_pnp_id, .handle = 0, .perm = BT_GATT_PERM_READ, }, }; const 
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c" 3 4
__attribute__((__aligned__(
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
...
# 105 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
struct bt_gatt_service_static dis_svc __attribute__((section("." "_bt_gatt_service_static" "." "static" "." "dis_svc_"))) __attribute__((__used__)) = { .attrs = attr_dis_svc, .attr_count = ((size_t) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(attr_dis_svc), __typeof__(&(attr_dis_svc)[0])))]) - 1) + (sizeof(attr_dis_svc) / sizeof((attr_dis_svc)[0])))), }
# 142 "/home/g/mise-work/zmk-firmware/zmk/zephyr/subsys/bluetooth/services/dis.c"
 ;
