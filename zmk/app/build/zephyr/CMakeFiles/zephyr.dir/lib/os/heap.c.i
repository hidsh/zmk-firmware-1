# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
...
# 258 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/sys_heap.h"
                                                    dump_chunks);
# 7 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 2
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/heap_listener.h" 1
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/heap_listener.h"
...
# 435 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/slist.h"
; }
# 13 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/heap_listener.h" 2
# 275 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/sys/heap_listener.h"
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 2
...
# 266 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.h"
                                           dump_chunks);
# 12 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 2
# 24 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
...
static chunkid_t mem_to_chunkid(struct z_heap *h, void *p)
{
 ...
 return (mem - chunk_header_bytes(h) - base) / 8U;
}

void sys_heap_free(struct sys_heap *heap, void *mem)
{
 if (mem == 
# 165 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
           ((void *)0)
# 165 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
               ) {
  return;
 }
 ...
 set_chunk_used(h, c, 
# 187 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                     0
# 187 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                          );
# 197 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 free_chunk(h, c);
}
...
size_t sys_heap_usable_size(struct sys_heap *heap, void *mem)
{
 ...
 size_t chunk_sz = chunk_size(h, c) * 8U;
...
static chunkid_t alloc_chunk(struct z_heap *h, chunksz_t sz)
{
 ...
 ;
# 232 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 if (b->next) {
 ...
 uint32_t bmask = h->avail_buckets & ~((1UL << (bi + 1)) - 1UL);
...
void *sys_heap_alloc(struct sys_heap *heap, size_t bytes)
{
 ...
 if (bytes == 0U || size_too_big(h, bytes)) {
  return 
# 269 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 269 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (c == 0U) {
  return 
# 275 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 275 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
 ...
 set_chunk_used(h, c, 
# 284 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                     1
# 284 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                         );

 mem = chunk_mem(h, c);
# 297 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 ;
 return mem;
}
...
void *sys_heap_aligned_alloc(struct sys_heap *heap, size_t align, size_t bytes)
{
 struct z_heap *h = heap->heap;
 size_t gap, rew;
# 313 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 rew = align & -align;
 if (align != rew) {
  align -= rew;
  gap = (((rew) < (chunk_header_bytes(h))) ? (rew) : (chunk_header_bytes(h)));
 } else {
 ...
 if (bytes == 0 || size_too_big(h, bytes)) {
  return 
# 327 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 327 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (c0 == 0) {
  return 
# 339 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 339 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
 uint8_t *mem = chunk_mem(h, c0);


 mem = (uint8_t *) ((((unsigned long)(mem + rew) + ((unsigned long)(align) - 1)) / (unsigned long)(align)) * (unsigned long)(align)) - rew;
 chunk_unit_t *end = (chunk_unit_t *) ((((unsigned long)(mem + bytes) + ((unsigned long)(8U) - 1)) / (unsigned long)(8U)) * (unsigned long)(8U));
 ...
 set_chunk_used(h, c, 
# 364 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                     1
# 364 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                         );
# 375 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 ;
 return mem;
}
          ...
          size_t align, size_t bytes)
{
 ...
 if (ptr == 
# 385 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
           ((void *)0)
# 385 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
               ) {
 ...
 if (bytes == 0) {
  ...
  return 
# 390 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 390 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (size_too_big(h, bytes)) {
  return 
# 396 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 396 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
            ;
 }
...
# 420 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
  split_chunks(h, c, c + chunks_need);
  set_chunk_used(h, c, 
# 421 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                      1
# 421 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                          );
  free_chunk(h, c + chunks_need);
# 431 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
  return ptr;
 } else if (!chunk_used(h, rc) &&
     (chunk_size(h, c) + chunk_size(h, rc) >= chunks_need)) {

  chunksz_t split_size = chunks_need - chunk_size(h, c);
# 445 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
  ...
  merge_chunks(h, c, rc);
  set_chunk_used(h, c, 
# 453 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                      1
# 453 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                          );
# 462 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
  return ptr;
 } else {
  ;
 }
# 474 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 void *ptr2 = sys_heap_aligned_alloc(heap, align, bytes);

 if (ptr2 != 
# 476 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
            ((void *)0)
# 476 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                ) {
  size_t prev_size = chunksz_to_bytes(h, chunk_size(h, c)) - align_gap;

  
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
 ((__builtin_object_size(
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 ptr2
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
...
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
 , 
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 (((prev_size) < (bytes)) ? (prev_size) : (bytes))
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
 , __builtin_object_size(
# 479 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
 ptr2
...
void sys_heap_init(struct sys_heap *heap, void *mem, size_t bytes)
{
 ...
 uintptr_t addr = ((((unsigned long)(mem) + ((unsigned long)(8U) - 1)) / (unsigned long)(8U)) * (unsigned long)(8U));
 uintptr_t end = (((unsigned long)((uint8_t *)mem + bytes) / (unsigned long)(8U)) * (unsigned long)(8U));
 chunksz_t heap_sz = (end - addr) / 8U;
 ...
 set_chunk_used(h, 0, 
# 533 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                     1
# 533 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                         );
 ...
 set_chunk_used(h, heap_sz, 
# 542 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c" 3 4
                           1
# 542 "/home/g/mise-work/zmk-firmware/zmk/zephyr/lib/os/heap.c"
                               );
