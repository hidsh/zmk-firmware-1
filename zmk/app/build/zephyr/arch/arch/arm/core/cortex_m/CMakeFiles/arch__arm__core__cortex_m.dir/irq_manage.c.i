# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
# 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
...
# 18 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c" 2
...
# 22 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c" 2
...
# 28 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c" 2
...
void arch_irq_enable(unsigned int irq)
{
 __NVIC_EnableIRQ((IRQn_Type)irq);
}

void arch_irq_disable(unsigned int irq)
{
 __NVIC_DisableIRQ((IRQn_Type)irq);
}

int arch_irq_is_enabled(unsigned int irq)
{
 return ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[(irq / 32)] & (1UL << ((irq % 32)));
}
# 59 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
void z_arm_irq_priority_set(unsigned int irq, unsigned int prio, uint32_t flags)
{
# 71 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
 if (0 && (flags & (1UL << (0)))) {
  if (1 == 1) {
   prio = 0;
  } else {
 ...
 { }
                                               ...
                                               ;
 __NVIC_SetPriority((IRQn_Type)irq, prio);
}

void z_arm_fatal_error(unsigned int reason, const z_arch_esf_t *esf);
# 103 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
void z_irq_spurious(const void *unused)
{
 (void)(unused);

 z_arm_fatal_error(K_ERR_SPURIOUS_IRQ, 
# 107 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c" 3 4
                                      ((void *)0)
# 107 "/home/g/mise-work/zmk-firmware/zmk/zephyr/arch/arm/core/cortex_m/irq_manage.c"
                                          );
}
