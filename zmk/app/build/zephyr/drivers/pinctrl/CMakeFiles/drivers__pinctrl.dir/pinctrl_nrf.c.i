# 0 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
...
int pinctrl_update_states(struct pinctrl_dev_config *config,
     const struct pinctrl_state *states,
     uint8_t state_cnt);
# 8 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c" 2

# 1 "/home/g/mise-work/zmk-firmware/zmk/modules/hal/nordic/nrfx/hal/nrf_gpio.h" 1
# 37 "/home/g/mise-work/zmk-firmware/zmk/modules/hal/nordic/nrfx/hal/nrf_gpio.h"
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/zephyr/modules/hal_nordic/nrfx/./nrfx_glue.h"
...
# 38 "/home/g/mise-work/zmk-firmware/zmk/modules/hal/nordic/nrfx/hal/nrf_gpio.h" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c" 2

_Static_assert(((0U == NRF_GPIO_PIN_NOPULL) && (1U == NRF_GPIO_PIN_PULLDOWN) && (3U == NRF_GPIO_PIN_PULLUP)), "" "nRF pinctrl pull settings do not match HAL values")


                                                           ;

_Static_assert(((0U == NRF_GPIO_PIN_S0S1) && (1U == NRF_GPIO_PIN_H0S1) && (2U == NRF_GPIO_PIN_S0H1) && (3U == NRF_GPIO_PIN_H0H1) && (4U == NRF_GPIO_PIN_D0S1) && (5U == NRF_GPIO_PIN_D0H1) && (6U == NRF_GPIO_PIN_S0D1) && (7U == NRF_GPIO_PIN_H0D1) && (1U)), "" "nRF pinctrl drive settings do not match HAL values")
# 28 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
                                                           ;
# 85 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
int pinctrl_configure_pins(const pinctrl_soc_pin_t *pins, uint8_t pin_cnt,
      uintptr_t reg)
{
 for (uint8_t i = 0U; i < pin_cnt; i++) {
  nrf_gpio_pin_drive_t drive = (((pins[i]) >> 9U) & 0xFU);
  uint32_t psel = (((pins[i]) >> 0U) & 0x7FU);
  uint32_t write = 
# 91 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c" 3 4
                  (0xffffffffUL)
# 91 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
                          ;
  nrf_gpio_pin_dir_t dir;
  nrf_gpio_pin_input_t input;
  ...
  switch ((((pins[i]) >> 16U) & 0xFFFFU)) {
# 125 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
  case 4U:
   ((NRF_SPIM_Type *)reg)->PSEL.SCK = psel;
   write = 0U;
   dir = NRF_GPIO_PIN_DIR_OUTPUT;
   input = NRF_GPIO_PIN_INPUT_CONNECT;
   break;
  case 5U:
   ((NRF_SPIM_Type *)reg)->PSEL.MOSI = psel;
   write = 0U;
   dir = NRF_GPIO_PIN_DIR_OUTPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 6U:
   ((NRF_SPIM_Type *)reg)->PSEL.MISO = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_CONNECT;
   break;
# 287 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
  case 29U:
   ((NRF_QSPI_Type *)reg)->PSEL.SCK = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 30U:
   ((NRF_QSPI_Type *)reg)->PSEL.CSN = psel;
   write = 1U;
   dir = NRF_GPIO_PIN_DIR_OUTPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 31U:
   ((NRF_QSPI_Type *)reg)->PSEL.IO0 = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 32U:
   ((NRF_QSPI_Type *)reg)->PSEL.IO1 = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 33U:
   ((NRF_QSPI_Type *)reg)->PSEL.IO2 = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  case 34U:
   ((NRF_QSPI_Type *)reg)->PSEL.IO3 = psel;
   dir = NRF_GPIO_PIN_DIR_INPUT;
   input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   break;
  ...
  default:
   return -
# 320 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c" 3 4
          134
# 320 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
                 ;
  }


  if (psel != 0xFFFFFFFFUL) {
   uint32_t pin = psel;

   if (write != 
# 327 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c" 3 4
               (0xffffffffUL)
# 327 "/home/g/mise-work/zmk-firmware/zmk/zephyr/drivers/pinctrl/pinctrl_nrf.c"
                       ) {
    nrf_gpio_pin_write(pin, write);
   }


   if ((((pins[i]) >> 13U) & 0x1U) == 1U) {
    dir = NRF_GPIO_PIN_DIR_INPUT;
    input = NRF_GPIO_PIN_INPUT_DISCONNECT;
   }

   nrf_gpio_cfg(pin, dir, input, (((pins[i]) >> 7U) & 0x3U),
