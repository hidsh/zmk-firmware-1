...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_STARTUP_DELAY_MS, 3000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_DYNAMIC_PINCTL_SPI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MICROCHIP_MCP3204_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_ANALOG_INPUT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_GPIO_595_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_WORKQUEUE_PRIORITY, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_WORKQUEUE_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_REPORT_INTERVAL_MIN, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_LOG_DBG_RAW, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_LOG_DBG_REPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_ADC_READ_HOOKS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_INPUT_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_ANALOG_INPUT_DRIVER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_595, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_595_INIT_PRIORITY, 75);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCP320X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCP320X_ACQUISITION_THREAD_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCP320X_ACQUISITION_THREAD_PRIO, 0);
