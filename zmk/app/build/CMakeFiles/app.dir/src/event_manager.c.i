# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 2
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
((void *)0)
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 2
...
int zmk_event_manager_handle_from(zmk_event_t *event, uint8_t start_index) {
    ...
    for (int i = start_index; i < len; i++) {
        ...
        case 1:
            do { if (!(1 && ((4U <= 0) || ((0 == 
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Listener handled the event" "\n", z_log_minimal_level_to_char(4U)); } while (
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
#pragma GCC diagnostic pop
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
            _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "Listener handled the event" == 
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           ((void *)0)
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { _plen = 0; } else { do {
...
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           28
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "Listener handled the event") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "Listener handled the event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener handled the event") + 0))) > (1)) ? (_Generic(("%s: " "Listener handled the event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener handled the event") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "Listener handled the event") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener handled the event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "Listener handled the event") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "Listener handled the event") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "Listener handled the event") + 0; double _d = _Generic(("%s: " "Listener handled the event") + 0, float : ("%s: " "Listener handled the event") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "Listener handled the event") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener handled the event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "Listener handled the event") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "Listener handled the event") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "Listener handled the event"; } } while (
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { z_log_printf_arg_checker("Listener handled the event"); } } while (
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 34 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           );
        ...
        case 2:
            do { if (!(1 && ((4U <= 0) || ((0 == 
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Listener captured the event" "\n", z_log_minimal_level_to_char(4U)); } while (
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ); break; } if (0 != 0 && !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic pop
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
            _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "Listener captured the event" == 
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           ((void *)0)
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { _plen = 0; } else { do {
...
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           28
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "Listener captured the event") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "Listener captured the event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener captured the event") + 0))) > (1)) ? (_Generic(("%s: " "Listener captured the event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener captured the event") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "Listener captured the event") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener captured the event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "Listener captured the event") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "Listener captured the event") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "Listener captured the event") + 0; double _d = _Generic(("%s: " "Listener captured the event") + 0, float : ("%s: " "Listener captured the event") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "Listener captured the event") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener captured the event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "Listener captured the event") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "Listener captured the event") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "Listener captured the event"; } } while (
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { z_log_printf_arg_checker("Listener captured the event"); } } while (
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 37 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           );
        ...
        default:
            do { if (!(1 && ((4U <= 0) || ((0 == 
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Listener returned an error: %d" "\n", z_log_minimal_level_to_char(4U), ret); } while (
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ); break; } if (0 != 0 && !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic pop
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
            _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "Listener returned an error: %d" == 
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           ((void *)0)
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { _plen = 0; } else { do {
...
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           28
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "Listener returned an error: %d") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "Listener returned an error: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener returned an error: %d") + 0))) > (1)) ? (_Generic(("%s: " "Listener returned an error: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "Listener returned an error: %d") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "Listener returned an error: %d") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener returned an error: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "Listener returned an error: %d") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "Listener returned an error: %d") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "Listener returned an error: %d") + 0; double _d = _Generic(("%s: " "Listener returned an error: %d") + 0, float : ("%s: " "Listener returned an error: %d") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "Listener returned an error: %d") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "Listener returned an error: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "Listener returned an error: %d") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "Listener returned an error: %d") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "Listener returned an error: %d"; } } while (
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           ) { z_log_printf_arg_checker("Listener returned an error: %d", ret); } } while (
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           0
# 40 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
           );
...
int zmk_event_manager_raise_after(zmk_event_t *event, const struct zmk_listener *listener) {
    ...
    do { if (!(1 && ((2U <= 0) || ((0 == 
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) && (2U <= __log_level) && (2U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Unable to find where to raise this after event" "\n", z_log_minimal_level_to_char(2U)); } while (
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
...
#pragma GCC diagnostic pop
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
    _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Unable to find where to raise this after event" == 
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   ((void *)0)
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) { _plen = 0; } else { do {
...
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   28
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Unable to find where to raise this after event") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Unable to find where to raise this after event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Unable to find where to raise this after event") + 0))) > (1)) ? (_Generic(("Unable to find where to raise this after event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Unable to find where to raise this after event") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Unable to find where to raise this after event") + 0; (void)__v; size_t __arg_size = _Generic(("Unable to find where to raise this after event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Unable to find where to raise this after event") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Unable to find where to raise this after event") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Unable to find where to raise this after event") + 0; double _d = _Generic(("Unable to find where to raise this after event") + 0, float : ("Unable to find where to raise this after event") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Unable to find where to raise this after event") + 0; (void)__v; size_t __arg_size = _Generic(("Unable to find where to raise this after event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Unable to find where to raise this after event") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Unable to find where to raise this after event") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Unable to find where to raise this after event"; } } while (
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) { z_log_printf_arg_checker("Unable to find where to raise this after event"); } } while (
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 60 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   );
    ...
    return -
# 62 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           22
# 62 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
                 ;
}
...
int zmk_event_manager_raise_at(zmk_event_t *event, const struct zmk_listener *listener) {
    ...
    do { if (!(1 && ((2U <= 0) || ((0 == 
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) && (2U <= __log_level) && (2U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Unable to find where to raise this event" "\n", z_log_minimal_level_to_char(2U)); } while (
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ); break; } if (0 != 0 && !0) { if (2U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic pop
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
    _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Unable to find where to raise this event" == 
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   ((void *)0)
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) { _plen = 0; } else { do {
...
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   28
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Unable to find where to raise this event") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Unable to find where to raise this event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Unable to find where to raise this event") + 0))) > (1)) ? (_Generic(("Unable to find where to raise this event") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Unable to find where to raise this event") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Unable to find where to raise this event") + 0; (void)__v; size_t __arg_size = _Generic(("Unable to find where to raise this event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Unable to find where to raise this event") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Unable to find where to raise this event") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Unable to find where to raise this event") + 0; double _d = _Generic(("Unable to find where to raise this event") + 0, float : ("Unable to find where to raise this event") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Unable to find where to raise this event") + 0; (void)__v; size_t __arg_size = _Generic(("Unable to find where to raise this event"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Unable to find where to raise this event") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Unable to find where to raise this event") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Unable to find where to raise this event"; } } while (
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   ) { z_log_printf_arg_checker("Unable to find where to raise this event"); } } while (
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
   0
# 75 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
   );
    ...
    return -
# 77 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c" 3 4
           22
# 77 "/home/g/mise-work/zmk-firmware/zmk/app/src/event_manager.c"
                 ;
}
