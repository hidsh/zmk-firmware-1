# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
# 9 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 2
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 2
...
# 76 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/keymap.h"
                                                                             pressed,
                                      int64_t timestamp);
# 14 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 2
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__unused__)) 
# 16 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
= 1 ? &log_const_zmk : 
# 16 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
((void *)0)
# 16 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 16 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
= 4;
# 39 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
static int mo_keymap_binding_pressed(struct zmk_behavior_binding *binding,
                                     struct zmk_behavior_binding_event event) {
    do { if (!(1 && ((4U <= 0) || ((0 == 
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "position %d layer %d" "\n", z_log_minimal_level_to_char(4U), event.position, binding->param1); } while (
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
#pragma GCC diagnostic pop
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
    _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((1 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("%s: " "position %d layer %d" == 
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   ((void *)0)
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   ) { _plen = 0; } else { do {
...
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   28
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "position %d layer %d") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "position %d layer %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "position %d layer %d") + 0))) > (1)) ? (_Generic(("%s: " "position %d layer %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "position %d layer %d") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("%s: " "position %d layer %d") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "position %d layer %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("%s: " "position %d layer %d") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("%s: " "position %d layer %d") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "position %d layer %d") + 0; double _d = _Generic(("%s: " "position %d layer %d") + 0, float : ("%s: " "position %d layer %d") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("%s: " "position %d layer %d") + 0; (void)__v; size_t __arg_size = _Generic(("%s: " "position %d layer %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "position %d layer %d") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "position %d layer %d") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "position %d layer %d"; } } while (
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   ) { z_log_printf_arg_checker("position %d layer %d", event.position, binding->param1); } } while (
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 41 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   );
...
static int mo_keymap_binding_released(struct zmk_behavior_binding *binding,
                                      struct zmk_behavior_binding_event event) {
    do { if (!(1 && ((4U <= 0) || ((0 == 
# 47 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 47 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
   ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "position %d layer %d" "\n", z_log_minimal_level_to_char(4U), event.position, binding->param1); } while (
# 47 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
   0
# 47 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
static 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__aligned__(
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
__alignof(struct device_state)
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
))) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
struct device_state __devstate_dts_ord_52 __attribute__((__section__(".z_devstate"))); _Static_assert(sizeof("\"momentary_layer\"") <= 48U, "" "DEVICE_NAME_GET(\"momentary_layer\")" " too long"); const 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__aligned__(
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
struct device __device_dts_ord_52 __attribute__((section("." "_device" "." "static" "." "3_40_"))) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__used__)) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
= { .name = "momentary_layer", .config = (
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
((void *)0)
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
), .api = (&behavior_mo_driver_api), .state = (&__devstate_dts_ord_52), .data = (
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
((void *)0)
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
), .pm = (
...
__attribute__((__used__)) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
__attribute__((__section__( ".z_init_" "POST_KERNEL" "40""_" "00052""_"))) __init___device_dts_ord_52 = { .init_fn = {.dev = (
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
((void *)0)
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
)}, .dev = &__device_dts_ord_52, }; static const 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__aligned__(
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
...
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
struct zmk_behavior_ref zmk_behavior___device_dts_ord_52 __attribute__((section("." "_zmk_behavior_ref" "." "static" "." "zmk_behavior___device_dts_ord_52_"))) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c" 3 4
__attribute__((__used__)) 
# 59 "/home/g/mise-work/zmk-firmware/zmk/app/src/behaviors/behavior_momentary_layer.c"
= { .device = (&__device_dts_ord_52), .metadata = {}, }; ;
                                                ;
