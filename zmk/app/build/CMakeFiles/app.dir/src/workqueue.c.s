...
.Ltext0:
	...
	.file 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/workqueue.c"
...
.LFB457:
	...
	.loc 1 18 33 is_stmt 0 view .LVU3
	push	{r0, r1, r2, lr}
...
.LVL0:
	...
	.loc 1 23 1 is_stmt 0 view .LVU6
	movs	r0, #0
	add	sp, sp, #12
...
.L2:
	.word	queue_config.0
	.word	lowprio_q_stack
	.word	lowprio_work_q
	.cfi_endproc
.LFE457:
	.size	workqueue_init, .-workqueue_init
	.section	.text.zmk_workqueue_lowprio_work_q,"ax",%progbits
	.align	1
	.global	zmk_workqueue_lowprio_work_q
	.syntax unified
	.thumb
	.thumb_func
	.type	zmk_workqueue_lowprio_work_q, %function
zmk_workqueue_lowprio_work_q:
.LFB456:
	.loc 1 16 53 is_stmt 1 view -0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 16 55 view .LVU8
	.loc 1 16 79 is_stmt 0 view .LVU9
	ldr	r0, .L5
	bx	lr
.L6:
	.align	2
.L5:
	...
	.cfi_endproc
.LFE456:
	.size	zmk_workqueue_lowprio_work_q, .-zmk_workqueue_lowprio_work_q
	.section	.rodata.str1.1,"aMS",%progbits,1
.LC0:
	.ascii	"Low Priority Work Queue\000"
...
queue_config.0:
	...
	.align	2
	.type	__init_workqueue_init, %object
	.size	__init_workqueue_init, 8
__init_workqueue_init:
	.word	workqueue_init
	.word	0
	.section	.bss.lowprio_work_q,"aw",%nobits
	.align	3
	.type	lowprio_work_q, %object
	.size	lowprio_work_q, 232
lowprio_work_q:
	.space	232
	.global	lowprio_q_stack
	.section	.noinit."WEST_TOPDIR/app/src/workqueue.c".0,"aw"
	.align	3
	.type	lowprio_q_stack, %object
	.size	lowprio_q_stack, 768
lowprio_q_stack:
	.space	768
	.text
.Letext0:
	...
	.file 17 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/device.h"
...
.LASF143:
	.ascii	"__init_workqueue_init\000"
.LASF127:
	.ascii	"state\000"
.LASF87:
	.ascii	"swap_data\000"
...
.LASF137:
	.ascii	"/home/g/mise-work/zmk-firmware/zmk/app/src/workqueu"
	.ascii	"e.c\000"
.LASF45:
