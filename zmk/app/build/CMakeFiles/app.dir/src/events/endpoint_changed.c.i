# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/endpoint_changed.h" 1
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/endpoint_changed.h" 2
...
# 13 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/endpoint_changed.h" 2

struct zmk_endpoint_changed {
    struct zmk_endpoint_instance endpoint;
};

struct zmk_endpoint_changed_event { zmk_event_t header; struct zmk_endpoint_changed data; }; struct zmk_endpoint_changed_event copy_raised_zmk_endpoint_changed(const struct zmk_endpoint_changed *ev); int raise_zmk_endpoint_changed(struct zmk_endpoint_changed); struct zmk_endpoint_changed *as_zmk_endpoint_changed(const zmk_event_t *eh); extern const struct zmk_event_type zmk_event_zmk_endpoint_changed;;
# 9 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c" 2

const struct zmk_event_type zmk_event_zmk_endpoint_changed = {.name = "zmk_endpoint_changed"}; const struct zmk_event_type *zmk_event_ref_zmk_endpoint_changed __attribute__((__used__)) __attribute__((__section__(".event_type"))) = &zmk_event_zmk_endpoint_changed; struct zmk_endpoint_changed_event copy_raised_zmk_endpoint_changed(const struct zmk_endpoint_changed *ev) { struct zmk_endpoint_changed_event *outer = ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(((struct zmk_endpoint_changed_event *)0)->data)) || __builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct zmk_endpoint_changed_event *)(((char *)(ev)) - 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c" 3 4
__builtin_offsetof (
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
struct zmk_endpoint_changed_event
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c" 3 4
, 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
)); }); return *outer; }; int raise_zmk_endpoint_changed(struct zmk_endpoint_changed data) { struct zmk_endpoint_changed_event ev = {.data = data, .header = {.event = &zmk_event_zmk_endpoint_changed}}; return zmk_event_manager_raise(&(ev).header); }; struct zmk_endpoint_changed *as_zmk_endpoint_changed(const zmk_event_t *eh) { return (eh->event == &zmk_event_zmk_endpoint_changed) ? &((struct zmk_endpoint_changed_event *)eh)->data : 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c" 3 4
((void *)0)
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/endpoint_changed.c"
; };;
