# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/ble_active_profile_changed.h" 1
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/ble_active_profile_changed.h" 2
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/ble_active_profile_changed.h" 2
...
# 14 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/ble_active_profile_changed.h" 2
...
struct zmk_ble_active_profile_changed_event { zmk_event_t header; struct zmk_ble_active_profile_changed data; }; struct zmk_ble_active_profile_changed_event copy_raised_zmk_ble_active_profile_changed(const struct zmk_ble_active_profile_changed *ev); int raise_zmk_ble_active_profile_changed(struct zmk_ble_active_profile_changed); struct zmk_ble_active_profile_changed *as_zmk_ble_active_profile_changed(const zmk_event_t *eh); extern const struct zmk_event_type zmk_event_zmk_ble_active_profile_changed;;
# 9 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c" 2

const struct zmk_event_type zmk_event_zmk_ble_active_profile_changed = {.name = "zmk_ble_active_profile_changed"}; const struct zmk_event_type *zmk_event_ref_zmk_ble_active_profile_changed __attribute__((__used__)) __attribute__((__section__(".event_type"))) = &zmk_event_zmk_ble_active_profile_changed; struct zmk_ble_active_profile_changed_event copy_raised_zmk_ble_active_profile_changed(const struct zmk_ble_active_profile_changed *ev) { struct zmk_ble_active_profile_changed_event *outer = ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(((struct zmk_ble_active_profile_changed_event *)0)->data)) || __builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct zmk_ble_active_profile_changed_event *)(((char *)(ev)) - 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c" 3 4
__builtin_offsetof (
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c"
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c"
)); }); return *outer; }; int raise_zmk_ble_active_profile_changed(struct zmk_ble_active_profile_changed data) { struct zmk_ble_active_profile_changed_event ev = {.data = data, .header = {.event = &zmk_event_zmk_ble_active_profile_changed}}; return zmk_event_manager_raise(&(ev).header); }; struct zmk_ble_active_profile_changed *as_zmk_ble_active_profile_changed(const zmk_event_t *eh) { return (eh->event == &zmk_event_zmk_ble_active_profile_changed) ? &((struct zmk_ble_active_profile_changed_event *)eh)->data : 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c" 3 4
((void *)0)
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/ble_active_profile_changed.c"
; };;
