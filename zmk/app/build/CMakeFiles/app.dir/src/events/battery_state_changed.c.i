# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 2
...
# 11 "/home/g/mise-work/zmk-firmware/zmk/app/include/zmk/events/battery_state_changed.h" 2
...
# 9 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 2

const struct zmk_event_type zmk_event_zmk_battery_state_changed = {.name = "zmk_battery_state_changed"}; const struct zmk_event_type *zmk_event_ref_zmk_battery_state_changed __attribute__((__used__)) __attribute__((__section__(".event_type"))) = &zmk_event_zmk_battery_state_changed; struct zmk_battery_state_changed_event copy_raised_zmk_battery_state_changed(const struct zmk_battery_state_changed *ev) { struct zmk_battery_state_changed_event *outer = ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(((struct zmk_battery_state_changed_event *)0)->data)) || __builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct zmk_battery_state_changed_event *)(((char *)(ev)) - 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
__builtin_offsetof (
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
struct zmk_battery_state_changed_event
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
, 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
data
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
)); }); return *outer; }; int raise_zmk_battery_state_changed(struct zmk_battery_state_changed data) { struct zmk_battery_state_changed_event ev = {.data = data, .header = {.event = &zmk_event_zmk_battery_state_changed}}; return zmk_event_manager_raise(&(ev).header); }; struct zmk_battery_state_changed *as_zmk_battery_state_changed(const zmk_event_t *eh) { return (eh->event == &zmk_event_zmk_battery_state_changed) ? &((struct zmk_battery_state_changed_event *)eh)->data : 
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
((void *)0)
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
; };;

const struct zmk_event_type zmk_event_zmk_peripheral_battery_state_changed = {.name = "zmk_peripheral_battery_state_changed"}; const struct zmk_event_type *zmk_event_ref_zmk_peripheral_battery_state_changed __attribute__((__used__)) __attribute__((__section__(".event_type"))) = &zmk_event_zmk_peripheral_battery_state_changed; struct zmk_peripheral_battery_state_changed_event copy_raised_zmk_peripheral_battery_state_changed(const struct zmk_peripheral_battery_state_changed *ev) { struct zmk_peripheral_battery_state_changed_event *outer = ({ _Static_assert(__builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(((struct zmk_peripheral_battery_state_changed_event *)0)->data)) || __builtin_types_compatible_p(__typeof__(*(ev)), __typeof__(void)), "" "pointer type mismatch in CONTAINER_OF"); ((struct zmk_peripheral_battery_state_changed_event *)(((char *)(ev)) - 
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
__builtin_offsetof (
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
struct zmk_peripheral_battery_state_changed_event
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
, 
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
data
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
)); }); return *outer; }; int raise_zmk_peripheral_battery_state_changed(struct zmk_peripheral_battery_state_changed data) { struct zmk_peripheral_battery_state_changed_event ev = {.data = data, .header = {.event = &zmk_event_zmk_peripheral_battery_state_changed}}; return zmk_event_manager_raise(&(ev).header); }; struct zmk_peripheral_battery_state_changed *as_zmk_peripheral_battery_state_changed(const zmk_event_t *eh) { return (eh->event == &zmk_event_zmk_peripheral_battery_state_changed) ? &((struct zmk_peripheral_battery_state_changed_event *)eh)->data : 
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c" 3 4
((void *)0)
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/events/battery_state_changed.c"
; };;
