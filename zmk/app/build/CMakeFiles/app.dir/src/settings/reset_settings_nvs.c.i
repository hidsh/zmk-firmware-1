# 0 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
# 0 "<command-line>" 2
# 1 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
# 8 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 2
...
# 50 "/home/g/zephyr-sdk-0.16.3/arm-zephyr-eabi/picolibc/include/sys/types.h" 2 3 4
...
# 39 "/home/g/mise-work/zmk-firmware/zmk/zephyr/include/zephyr/storage/flash_map.h" 2
...
# 10 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 2
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 2
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
__attribute__((__unused__)) 
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
= 1 ? &log_const_zmk : 
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
((void *)0)
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
# 12 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
= 4;
# 21 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
int zmk_settings_erase(void) {
    do { if (!(1 && ((3U <= 0) || ((0 == 
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   0
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
   ) && (3U <= __log_level) && (3U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Erasing settings flash partition" "\n", z_log_minimal_level_to_char(3U)); } while (
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   0
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
#pragma GCC diagnostic pop
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
    _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Erasing settings flash partition" == 
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   ((void *)0)
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
   ) { _plen = 0; } else { do {
...
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   28
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
   ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Erasing settings flash partition") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Erasing settings flash partition") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Erasing settings flash partition") + 0))) > (1)) ? (_Generic(("Erasing settings flash partition") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Erasing settings flash partition") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Erasing settings flash partition") + 0; (void)__v; size_t __arg_size = _Generic(("Erasing settings flash partition"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Erasing settings flash partition") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Erasing settings flash partition") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Erasing settings flash partition") + 0; double _d = _Generic(("Erasing settings flash partition") + 0, float : ("Erasing settings flash partition") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Erasing settings flash partition") + 0; (void)__v; size_t __arg_size = _Generic(("Erasing settings flash partition"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Erasing settings flash partition") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Erasing settings flash partition") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Erasing settings flash partition"; } } while (
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   0
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   0
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
   ) { z_log_printf_arg_checker("Erasing settings flash partition"); } } while (
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
   0
# 22 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
   );
    ...
    int rc = flash_area_open(2, &fa);
    if (rc) {
        do { if (!(1 && ((1U <= 0) || ((0 == 
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) && (1U <= __log_level) && (1U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Failed to open settings flash: %d" "\n", z_log_minimal_level_to_char(1U), rc); } while (
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
...
#pragma GCC diagnostic pop
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
        _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Failed to open settings flash: %d" == 
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       ((void *)0)
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) { _plen = 0; } else { do {
...
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       28
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Failed to open settings flash: %d") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Failed to open settings flash: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Failed to open settings flash: %d") + 0))) > (1)) ? (_Generic(("Failed to open settings flash: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Failed to open settings flash: %d") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Failed to open settings flash: %d") + 0; (void)__v; size_t __arg_size = _Generic(("Failed to open settings flash: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Failed to open settings flash: %d") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Failed to open settings flash: %d") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Failed to open settings flash: %d") + 0; double _d = _Generic(("Failed to open settings flash: %d") + 0, float : ("Failed to open settings flash: %d") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Failed to open settings flash: %d") + 0; (void)__v; size_t __arg_size = _Generic(("Failed to open settings flash: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Failed to open settings flash: %d") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Failed to open settings flash: %d") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Failed to open settings flash: %d"; } } while (
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) { z_log_printf_arg_checker("Failed to open settings flash: %d", rc); } } while (
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 27 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       );
    ...
    if (rc) {
        do { if (!(1 && ((1U <= 0) || ((0 == 
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) && (1U <= __log_level) && (1U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Failed to erase settings flash: %d" "\n", z_log_minimal_level_to_char(1U), rc); } while (
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ); break; } if (0 != 0 && !0) { if (1U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic pop
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
        _rv; }); if (0 && 1 && ((0) == 0) && !has_rw_str) { ; ; _mode = Z_LOG_MSG_MODE_ZERO_COPY; } else { ; do { int _plen; uint32_t _options = ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (1UL << (2)); if ("Failed to erase settings flash: %d" == 
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       ((void *)0)
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) { _plen = 0; } else { do {
...
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       28
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ; break; } _len_loc = (union cbprintf_package_hdr *)_pbuf; _pkg_len += sizeof(*_len_loc); _pkg_offset += sizeof(*_len_loc); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Failed to erase settings flash: %d") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Failed to erase settings flash: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Failed to erase settings flash: %d") + 0))) > (1)) ? (_Generic(("Failed to erase settings flash: %d") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Failed to erase settings flash: %d") + 0))) : (1)) != 0UL) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type __v = ("Failed to erase settings flash: %d") + 0; (void)__v; size_t __arg_size = _Generic(("Failed to erase settings flash: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); uint32_t _loc = _pkg_len / sizeof(int); if (0 < 1 + _fros_cnt) { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } else if (_Generic(("Failed to erase settings flash: %d") + 0, char * : 1, const char * : ((0) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((0) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((0) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { if (_cros_en) { if ((0 < (((_flags) >> 3) & ((1UL << (3)) - 1UL)) ? 0 : _Generic(("Failed to erase settings flash: %d") + 0, char * : 1, const char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, unsigned char * : 1, const unsigned char * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile unsigned char * : 1, const volatile unsigned char * : 1, wchar_t * : 1, const wchar_t * : ((_flags) & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0))) { if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _loc; } } else { if (_ros_pos_en) { _ros_pos_buf[_ros_pos_idx++] = _loc; } } } else if (_rws_pos_en) { _rws_buffer[_rws_pos_idx++] = 0 - 1; _rws_buffer[_rws_pos_idx++] = _pkg_len / sizeof(int); } } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Failed to erase settings flash: %d") + 0; double _d = _Generic(("Failed to erase settings flash: %d") + 0, float : ("Failed to erase settings flash: %d") + 0, default : 0.0); (void)_v; (void)_d; size_t arg_size = ({ __auto_type __v = ("Failed to erase settings flash: %d") + 0; (void)__v; size_t __arg_size = _Generic(("Failed to erase settings flash: %d"), float : sizeof(double), default : sizeof((__v)) ); __arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Failed to erase settings flash: %d") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Failed to erase settings flash: %d") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Failed to erase settings flash: %d"; } } while (
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (
...
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       ) { z_log_printf_arg_checker("Failed to erase settings flash: %d", rc); } } while (
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c" 3 4
       0
# 33 "/home/g/mise-work/zmk-firmware/zmk/app/src/settings/reset_settings_nvs.c"
       );
